        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="collapse navbar-collapse d-flex justify-content-center align-items-center" id="navbarNavAltMarkup">
             <marquee width="100%" direction="left" behavior="alternate" ><span style="font-size:38px;font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Employee Management System</span>
        </marquee>
